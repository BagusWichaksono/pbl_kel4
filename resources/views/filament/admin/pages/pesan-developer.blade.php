                    ...
                    <div class="admin-chat-header-content">
                        <div class="admin-chat-user">
                            <div class="admin-chat-avatar">
                                {{ strtoupper(substr($this->selectedTicket->tester?->name ?? 'D', 0, 1)) }}
                            </div>

                            <div>
                                <h2 class="admin-chat-name">
                                    {{ $this->selectedTicket->tester?->name ?? 'Developer' }}
                                </h2>
                        ...
                        <div class="admin-message-row {{ $isAdmin ? 'mine' : 'developer' }}">
                            <div class="admin-message-content">
                                <div class="admin-message-avatar-small">
                                    {{ $isAdmin ? 'A' : strtoupper(substr($chat->sender?->name ?? 'D', 0, 1)) }}
                                </div>

                                <div>
                                    <div class="admin-message-meta">
                                        {{ $isAdmin ? 'Admin' : ($chat->sender?->name ?? 'Developer') }}
                                    </div>
