    ...
    <div style="display:flex; flex-direction:column; gap:1.5rem;">
        ...
        @forelse ($this->groupedReports as $appName => $reportsByDate)
            <div class="overflow-hidden border shadow-sm" style="border-radius:29px; border-color:rgba(var(--tesyuk-accent-rgb),0.18); background:#FFFFFF;">
                ...
                <div class="px-6 py-5" style="background: linear-gradient(135deg, var(--tesyuk-ink) 0%, var(--tesyuk-ink) 68%, var(--tesyuk-primary) 88%, var(--tesyuk-accent) 100%);">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs" style="color:rgba(238,238,238,0.72);">
                ...
                {{-- CARD PER TANGGAL --}}
                <div style="display:flex; flex-direction:column; gap:1rem; padding:1rem; background:#fffafa;">
                    @foreach ($reportsByDate as $date => $reports)
                        <div class="overflow-hidden rounded-xl border" style="border-color:rgba(var(--tesyuk-accent-rgb),0.18);">

                            {{-- LABEL TANGGAL --}}
                            <div class="flex items-center justify-between px-4 py-3"
                                style="background:var(--tesyuk-secondary); border-bottom:1px solid rgba(var(--tesyuk-accent-rgb),0.18);">
                                <div class="flex items-center gap-2">
                                    <x-heroicon-o-calendar-days class="h-3.5 w-3.5" style="color:var(--tesyuk-accent);" />
                                    <span class="text-xs font-bold uppercase tracking-widest" style="color:var(--tesyuk-primary);">
                                        {{ \Carbon\Carbon::parse($date)->translatedFormat('l, d F Y') }}
                                    </span>
                                </div>
                                <span class="rounded-full px-2.5 py-0.5 text-xs font-semibold"
                                    style="background:rgba(var(--tesyuk-accent-rgb),0.18); color:var(--tesyuk-primary);">
                            ...
                            <div style="background:#FFFFFF;">
                                @foreach ($reports as $report)
                                    <div x-data="{ open: false }"
                                        ...
                                        x-on:mouseover="$el.style.background='#fffafa'"
                                        ...
                                        <div x-show="open"
                                            ...
                                            style="background:rgba(var(--tesyuk-ink-rgb),0.55); backdrop-filter:blur(4px);"
                                            x-cloak>
                                            <div x-on:click.stop
                                                x-transition:enter="transition ease-out duration-200"
                                                ...
                                                style="background:#FFFFFF; border:1px solid rgba(var(--tesyuk-accent-rgb),0.18);">

                                                {{-- MODAL HEADER --}}
                                                <div class="flex items-start justify-between gap-4 px-6 py-5"
                                                    style="background: linear-gradient(135deg, var(--tesyuk-ink) 0%, var(--tesyuk-ink) 68%, var(--tesyuk-primary) 88%, var(--tesyuk-accent) 100%);">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mt-1 text-xs" style="color:rgba(238,238,238,0.72);">
                                                ...
                                                <div style="max-height:75vh; overflow-y:auto; padding:1.5rem; display:flex; flex-direction:column; gap:1.5rem;">
                                                    ...
                                                    <div>
                                                        <div class="mb-3 flex items-center gap-2">
                                                            ...
                                                            <span class="text-sm font-bold" style="color:var(--tesyuk-primary);">Catatan</span>
                                                        </div>
                                                        <div class="rounded-xl px-4 py-4"
                                                            style="background:var(--tesyuk-secondary); border:1px solid rgba(var(--tesyuk-accent-rgb),0.18);">
                                                            <p class="whitespace-pre-line text-sm leading-7" style="color:var(--tesyuk-ink);">
                                                    ...
                                                    @else
                                                        <div>
                                                            <div class="mb-3 flex items-center gap-2">
                                                                <x-heroicon-o-bug-ant class="h-4 w-4" style="color:var(--tesyuk-accent);" />
                                                                <span class="text-sm font-bold" style="color:var(--tesyuk-primary);">Laporan Bug</span>
                                                            </div>
                                                            <div class="rounded-xl px-4 py-4"
                                                                style="background:var(--tesyuk-secondary); border:1px solid rgba(var(--tesyuk-accent-rgb),0.18);">
                                                                <p class="text-sm" style="color:#64748b;">Tidak ada laporan bug pada hari ini.</p>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div>
                                                        <div class="mb-3 flex items-center gap-2">
                                                            <x-heroicon-o-photo class="h-4 w-4" style="color:var(--tesyuk-accent);" />
                                                            <span class="text-sm font-bold" style="color:var(--tesyuk-primary);">Screenshot</span>
                                                        </div>
                                                        @if($report->screenshot)
                                                            <div class="overflow-hidden rounded-xl border p-2"
                                                                style="border-color:rgba(var(--tesyuk-accent-rgb),0.18); background:#F8FAFC;">
                                                        ...
                                                        @else
                                                            <div class="flex flex-col items-center justify-center rounded-xl py-10"
                                                                style="background:var(--tesyuk-secondary); border:1px dashed rgba(var(--tesyuk-accent-rgb),0.18);">
                                                                <x-heroicon-o-photo class="mb-2 h-8 w-8" style="color:#64748b;" />
                                                                <p class="text-sm" style="color:#64748b;">Tidak ada screenshot.</p>
                                                            </div>
                                                        @endif
                                                    </div>
        ...
        @empty
            <div class="flex flex-col items-center justify-center rounded-2xl border py-16 text-center shadow-sm"
                style="background:var(--tesyuk-secondary); border-color:rgba(var(--tesyuk-accent-rgb),0.18);">
                <div class="mb-4 flex h-14 w-14 items-center justify-center rounded-xl" style="background:rgba(var(--tesyuk-accent-rgb),0.18);">
                    <x-heroicon-o-clipboard-document-list class="h-7 w-7" style="color:var(--tesyuk-accent);" />
                </div>
                <h2 class="text-base font-bold" style="color:var(--tesyuk-ink);">Belum Ada Laporan Harian</h2>
                <p class="mt-2 max-w-xs text-sm" style="color:#64748b;">
