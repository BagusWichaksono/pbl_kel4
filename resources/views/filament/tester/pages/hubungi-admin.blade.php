<x-filament-panels::page>
    ...
    >
        <div class="chat-card">
            ...
            <div style="padding: 16px 28px; background-color: #fffbeb; border-bottom: 1px solid #fde68a; display: flex; gap: 12px; align-items: flex-start;">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#d97706" style="width: 24px; height: 24px; flex-shrink: 0; margin-top: 2px;">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
                </svg>
                <div>
                    <p style="margin: 0; font-size: 13.5px; color: #92400e; line-height: 1.5;">
                        <strong>Catatan:</strong> Fitur chat ini khusus untuk pertanyaan seputar platform <strong>TesYuk</strong> seperti akun, verifikasi, dashboard, misi, poin, atau kendala sistem.<br>
                        <strong>Bukan untuk menanyakan aplikasi milik developer yang sedang diuji.</strong> Gunakan instruksi misi dan form report untuk aplikasi tersebut.
                    </p>
                </div>
            </div>
                            ...
                            <div>
                                ...
                                <div class="message-bubble">
                                    ...
                                    <div class="message-time">
                                        ...
                                        @if ($isMine)
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="{{ $chat->is_read ? '#3b82f6' : '#9ca3af' }}" viewBox="0 0 16 16" style="width: 14px; height: 14px; display: inline-block; margin-bottom: -2px; margin-left: 3px;">
