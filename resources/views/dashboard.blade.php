<head>
    ...
    <title>Dashboard Tester - TesYuk!</title>
...
<body class="bg-[#F8FAFC] text-slate-800 min-h-screen flex flex-col">
    ...
    <div class="flex flex-1">
        <aside class="w-64 bg-white border-r border-slate-200 p-6 space-y-4 hidden md:block">
            <a href="#" class="flex items-center gap-3 p-3 rounded-xl bg-slate-100 text-blue-600 font-semibold border border-slate-200"><i class="ph-fill ph-house text-xl"></i> Home</a>
            <a href="#" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition text-slate-500"><i class="ph-fill ph-coin text-xl"></i> Poin</a>
            <a href="#" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition text-slate-500"><i class="ph-fill ph-user text-xl"></i> Profile</a>
        </aside>
