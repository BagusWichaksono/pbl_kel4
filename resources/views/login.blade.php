        ...
        <form action="/login" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input name="email" type="email" placeholder="Masukkan email" value="{{ old('email') }}" required 
                    class="w-full px-5 py-3.5 bg-slate-50 border @error('email') border-red-500 @else border-slate-200 @enderror rounded-2xl focus:ring-2 focus:ring-slate-900 outline-none transition">
            ...
            <div>
                ...
                <input name="password" type="password" placeholder="•••••" required 
                    class="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-slate-900 outline-none transition">
            </div>       
