...
<body id="page-content" class="bg-winter-50 min-h-screen flex items-center justify-center p-6 py-12 md:py-20 relative bg-grid-pattern font-sans antialiased overflow-y-auto custom-scrollbar opacity-0 transition-opacity duration-500 ease-in-out">
    ...
    <div class="bg-white/90 backdrop-blur-2xl p-8 lg:p-10 rounded-[2.5rem] border border-white max-w-md w-full relative z-10" style="box-shadow: 0 50px 100px -20px rgba(var(--tesyuk-ink-rgb), 0.15);">
        ...
        <form action="/register" method="POST" class="space-y-4" novalidate>
            ...
            <div>
                <label class="block text-[10px] font-black text-winter-900/70 uppercase tracking-widest ml-1 mb-1.5">Nama</label>
                <input type="text" name="name" placeholder="Masukkan nama" required value="{{ old('name') }}"
                    ...
                    class="w-full px-5 py-3 bg-white/50 border border-winter-300/30 rounded-2xl focus:ring-4 focus:ring-winter-900/10 focus:border-winter-900 outline-none transition-all text-winter-900 font-medium">
                @error('name')
            ...
            <div>
                <label class="block text-[10px] font-black text-winter-900/70 uppercase tracking-widest ml-1 mb-1.5">Email</label>
            ...
            <div class="pt-2">
                <label class="block text-[10px] font-black text-winter-900/70 uppercase tracking-widest ml-1 mb-3 text-center">Daftar Sebagai</label>
                <div class="grid grid-cols-2 gap-4">
                    <label class="relative block cursor-pointer group">
                        <input type="radio" name="role" value="developer" class="peer sr-only" required {{ old('role') == 'developer' ? 'checked' : '' }}>
                        <div class="flex flex-col items-center justify-center p-4 rounded-2xl border-2 border-winter-300/20 bg-white transition-all peer-checked:border-winter-900 peer-checked:bg-winter-50 peer-checked:ring-4 peer-checked:ring-winter-900/10 hover:border-winter-300 hover:shadow-md">
                            <div class="w-10 h-10 bg-winter-50 rounded-xl flex items-center justify-center text-winter-900 group-hover:scale-110 transition-transform peer-checked:bg-winter-900 peer-checked:text-white mb-2">
                    ...
                    <label class="relative block cursor-pointer group">
                        ...
                        <div class="flex flex-col items-center justify-center p-4 rounded-2xl border-2 border-winter-300/20 bg-white transition-all peer-checked:border-winter-900 peer-checked:bg-winter-50 peer-checked:ring-4 peer-checked:ring-winter-900/10 hover:border-winter-300 hover:shadow-md text-center">
                            <div class="w-10 h-10 bg-winter-50 rounded-xl flex items-center justify-center text-winter-900 group-hover:scale-110 transition-transform peer-checked:bg-winter-900 peer-checked:text-white mb-2">
            ...
            <div class="space-y-4 pt-2">
                <div class="group relative">
                    <label class="block text-[10px] font-black text-winter-900/70 uppercase tracking-widest ml-1 mb-1.5">Kata Sandi</label>
                    <div class="relative">
                        <input id="reg-password" type="password" name="password" placeholder="••••••••" required minlength="8" title="Password minimal 8 karakter"
                            class="w-full pl-5 pr-12 py-3 bg-white/50 border border-winter-300/30 rounded-2xl focus:ring-4 focus:ring-winter-900/10 focus:border-winter-900 outline-none transition-all text-winter-900 font-medium">
                        <button type="button" onclick="togglePassword('reg-password', 'eye-icon-reg')" class="absolute right-4 top-1/2 -translate-y-1/2 text-winter-900/40 hover:text-winter-900 transition-colors focus:outline-none">
                ...
                <div class="group relative">
                    <label class="block text-[10px] font-black text-winter-900/70 uppercase tracking-widest ml-1 mb-1.5">Konfirmasi Kata Sandi</label>
                    <div class="relative">
                        <input id="reg-password-confirm" type="password" name="password_confirmation" placeholder="••••••••" required minlength="8"
                            class="w-full pl-5 pr-12 py-3 bg-white/50 border border-winter-300/30 rounded-2xl focus:ring-4 focus:ring-winter-900/10 focus:border-winter-900 outline-none transition-all text-winter-900 font-medium">
                        <button type="button" onclick="togglePassword('reg-password-confirm', 'eye-icon-confirm')" class="absolute right-4 top-1/2 -translate-y-1/2 text-winter-900/40 hover:text-winter-900 transition-colors focus:outline-none">
            ...
            <button type="submit" class="w-full bg-winter-900 text-white py-4 rounded-2xl font-bold hover:bg-winter-800 hover:-translate-y-1 active:scale-95 transition-all shadow-xl shadow-winter-900/20 mt-6 uppercase">
                Daftar
            </button>
        </form>

        <p class="text-center text-sm text-winter-700/80 font-medium mt-6">
            Sudah punya akun? <a href="/login" class="text-winter-900 font-bold hover:text-winter-700 transition-colors underline decoration-2 underline-offset-4">Login di sini</a>
        </p>
    </div>
