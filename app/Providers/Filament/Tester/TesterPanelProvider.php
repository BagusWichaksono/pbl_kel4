                            ...
                            <div style="background:linear-gradient(to right, #eff6ff, #ffffff);border:1px solid #bfdbfe;border-left:4px solid #3b82f6;border-radius:16px;padding:1.25rem 1.5rem;display:flex;gap:1rem;align-items:flex-start;">
                                ...
                                <div>
                                    ...
                                    <div style="font-size:.875rem;color:#1d4ed8;line-height:1.6;margin-top:.25rem;">
                                        Grafik di bawah menampilkan poin masuk, poin dicairkan, dan misi selesai selama 6 bulan terakhir. Anda dapat mengarahkan kursor ke titik atau batang grafik untuk melihat detail angka per bulan dengan lebih jelas.
                                    </div>
                                </div>
                            </div>
                        </div>
...
HTML);
            ...
            ->renderHook(
                ...
                fn (): string => \Illuminate\Support\Facades\Blade::render('<livewire:support-chat-widget role="tester" />')
            )
