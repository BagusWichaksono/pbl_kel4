...
class CariMisiResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Cari Misi';
                ...
                Tables\Columns\Layout\Stack::make([
                    Tables\Columns\TextColumn::make('mission_card')
                        ...
                        ->formatStateUsing(function ($state, App $record): HtmlString {
                            ...
                            $developerName = e($record->developer?->name ?? 'Developer');
                            ...
                            $statusLabel = match (true) {
                                $isRegistered => 'Sudah Diambil',
                                $isFull => 'Slot Penuh',
                                default => 'Tersedia',
                            };

                            $statusStyle = match (true) {
                                $isRegistered => 'background:#f1f5f9;color:#64748b;border:1px solid #e2e8f0;',
                                $isFull => 'background:#fff1f2;color:#be123c;border:1px solid #fecdd3;',
                                default => 'background:#ecfdf5;color:#047857;border:1px solid #bbf7d0;',
                            };
                            ...
                            return new HtmlString(<<<HTML
                                ...
                                ">
                                    ...
                                    <div style="padding:1.15rem 1.15rem 1rem;">
                                        <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:.75rem;">
